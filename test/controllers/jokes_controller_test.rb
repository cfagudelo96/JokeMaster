...
class JokesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create joke" do
    assert_difference('Joke.count') do
      post jokes_url, params: { joke: { category: @joke.category, content: @joke.content, subject: @joke.subject } }, as: :json
    end
  ...
  test "should update joke" do
    patch joke_url(@joke), params: { joke: { category: @joke.category, content: @joke.content, subject: @joke.subject } }, as: :json
    assert_response 200
  end
